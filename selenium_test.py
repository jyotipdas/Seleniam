...
time.sleep(30)
#find the 2 smallest amount for the day

price1 = driver.find_element_by_xpath("//*[@id='content']/div/div[5]/div[5]/div[2]/div[5]/div/div[2]/div[6]/p[1]/span[2]").text
price2 = driver.find_element_by_xpath("//*[@id='content']/div/div[5]/div[5]/div[2]/div[6]/div/div[2]/div[6]/p[1]/span[2]").text

print "Prices for Pune to Kolkata for 2th Feb 2018 are {} and {}".format(price1,price2)
...
my_sms = 'Flight Price {} and {}'.format(price1,price2)

message = client.messages.create(to=my_no , from_=my_twilio , body=my_sms)
